...
import { fetchMovies } from "../api/MovieAPI"; // adjust path if needed
...
const Movie: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Recommender rows (static for now) */}
      ...
      {/* Scrollable / filterable movie section */}
