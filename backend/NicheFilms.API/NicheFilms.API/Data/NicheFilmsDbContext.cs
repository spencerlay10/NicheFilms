...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:nichefilms.database.windows.net,1433;Initial Catalog=NicheFilms;Persist Security Info=False;User ID=nicheadmin;Password=Gators2025!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<HybridRecommendation>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("hybrid_recommendations");
        ...
        modelBuilder.Entity<UserRecommendation>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("user_recommendations");

            entity.Property(e => e.MovieRec1)
                .HasColumnType("text")
                .HasColumnName("movie_rec_1");
            entity.Property(e => e.MovieRec10)
                .HasColumnType("text")
                .HasColumnName("movie_rec_10");
            entity.Property(e => e.MovieRec2)
                .HasColumnType("text")
                .HasColumnName("movie_rec_2");
            entity.Property(e => e.MovieRec3)
                .HasColumnType("text")
                .HasColumnName("movie_rec_3");
            entity.Property(e => e.MovieRec4)
                .HasColumnType("text")
                .HasColumnName("movie_rec_4");
            entity.Property(e => e.MovieRec5)
                .HasColumnType("text")
                .HasColumnName("movie_rec_5");
            entity.Property(e => e.MovieRec6)
                .HasColumnType("text")
                .HasColumnName("movie_rec_6");
            entity.Property(e => e.MovieRec7)
                .HasColumnType("text")
                .HasColumnName("movie_rec_7");
            entity.Property(e => e.MovieRec8)
                .HasColumnType("text")
                .HasColumnName("movie_rec_8");
            entity.Property(e => e.MovieRec9)
                .HasColumnType("text")
                .HasColumnName("movie_rec_9");
            entity.Property(e => e.NicheRec1)
                .HasColumnType("text")
                .HasColumnName("niche_rec_1");
            entity.Property(e => e.NicheRec10)
                .HasColumnType("text")
                .HasColumnName("niche_rec_10");
            entity.Property(e => e.NicheRec2)
                .HasColumnType("text")
                .HasColumnName("niche_rec_2");
            entity.Property(e => e.NicheRec3)
                .HasColumnType("text")
                .HasColumnName("niche_rec_3");
            entity.Property(e => e.NicheRec4)
                .HasColumnType("text")
                .HasColumnName("niche_rec_4");
            entity.Property(e => e.NicheRec5)
                .HasColumnType("text")
                .HasColumnName("niche_rec_5");
            entity.Property(e => e.NicheRec6)
                .HasColumnType("text")
                .HasColumnName("niche_rec_6");
            entity.Property(e => e.NicheRec7)
                .HasColumnType("text")
                .HasColumnName("niche_rec_7");
            entity.Property(e => e.NicheRec8)
                .HasColumnType("text")
                .HasColumnName("niche_rec_8");
            entity.Property(e => e.NicheRec9)
                .HasColumnType("text")
                .HasColumnName("niche_rec_9");
            entity.Property(e => e.Rec1)
                .HasColumnType("text")
                .HasColumnName("rec_1");
            entity.Property(e => e.Rec10)
                .HasColumnType("text")
                .HasColumnName("rec_10");
            entity.Property(e => e.Rec2)
                .HasColumnType("text")
                .HasColumnName("rec_2");
            entity.Property(e => e.Rec3)
            ...
            entity.Property(e => e.Rec5)
                .HasColumnType("text")
                .HasColumnName("rec_5");
            entity.Property(e => e.Rec6)
                .HasColumnType("text")
                .HasColumnName("rec_6");
            entity.Property(e => e.Rec7)
                .HasColumnType("text")
                .HasColumnName("rec_7");
            entity.Property(e => e.Rec8)
                .HasColumnType("text")
                .HasColumnName("rec_8");
            entity.Property(e => e.Rec9)
                .HasColumnType("text")
                .HasColumnName("rec_9");
            entity.Property(e => e.TvRec1)
                .HasColumnType("text")
                .HasColumnName("tv_rec_1");
            entity.Property(e => e.TvRec10)
                .HasColumnType("text")
                .HasColumnName("tv_rec_10");
            entity.Property(e => e.TvRec2)
                .HasColumnType("text")
                .HasColumnName("tv_rec_2");
            entity.Property(e => e.TvRec3)
                .HasColumnType("text")
                .HasColumnName("tv_rec_3");
            entity.Property(e => e.TvRec4)
                .HasColumnType("text")
                .HasColumnName("tv_rec_4");
            entity.Property(e => e.TvRec5)
                .HasColumnType("text")
                .HasColumnName("tv_rec_5");
            entity.Property(e => e.TvRec6)
                .HasColumnType("text")
                .HasColumnName("tv_rec_6");
            entity.Property(e => e.TvRec7)
                .HasColumnType("text")
                .HasColumnName("tv_rec_7");
            entity.Property(e => e.TvRec8)
                .HasColumnType("text")
                .HasColumnName("tv_rec_8");
            entity.Property(e => e.TvRec9)
                .HasColumnType("text")
                .HasColumnName("tv_rec_9");
            entity.Property(e => e.UserId).HasColumnName("user_id");
        });
